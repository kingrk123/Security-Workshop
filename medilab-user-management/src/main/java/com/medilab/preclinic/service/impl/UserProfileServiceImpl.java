...
import com.medilab.preclinic.util.NotificationOutboundCommunicator;
...
public class UserProfileServiceImpl implements UserProfileService {
	...
	@Autowired
	private NotificationOutboundCommunicator notificationComm;
	...
	public MedilabUserBean createUser(MedilabUserBean userBean, String callbackUrl) {
		...
		notificationComm.sendConfirmAccountEmail(confirmAccountJsonBody.toString());
